...
// 这里的 tags 必须严格对应 data-zh.ts 里定义的 Persona 类型：
...
export const scenariosEn: Scenario[] = [
  ...
  },
  {
    ...
    tags: ['Student', 'Worker', 'Entrepreneur'], // Removed Founder/Investor
    tools: [
      ...
      { id: 'genspark', name: 'Genspark', rank: 'A', tagline: 'Generate Sparkpages', pros: ['Visual summary', 'Video aggregation'], cons: ['Slower'], priceModel: 'Free', link: 'https://www.genspark.ai', logo: '✨', lastCheck: '2025-12-01' }
    ]
  },
  ...
  // --- Office ---
  {
    ...
    tags: ['Worker', 'Student', 'Entrepreneur'], // Removed Teacher/Founder
    tools: [
      ...
      { id: 'beautiful', name: 'Beautiful.ai', rank: 'A', tagline: 'Smart slide designer', pros: ['Corporate standard', 'Smart layout'], cons: ['Paid only'], priceModel: 'Paid', link: 'https://www.beautiful.ai', logo: '🅱️', lastCheck: '2025-12-01' }
    ]
  },
  {
    id: 'long-doc', title: 'Chat with PDF', description: 'Summarize long documents & papers', icon: 'doc',
    tags: ['Student', 'Entrepreneur', 'Worker'], // Removed Investor
    tools: [
      ...
      { id: 'chatpdf', name: 'ChatPDF', rank: 'A', tagline: 'Simple PDF wrapper', pros: ['Easy to use', 'No login needed'], cons: ['Basic reasoning'], priceModel: 'Freemium', link: 'https://www.chatpdf.com', logo: '📄', lastCheck: '2025-12-01' }
    ]
  },
  {
    ...
    tools: [
      ...
      { id: 'fireflies', name: 'Fireflies.ai', rank: 'A', tagline: 'Automated note taker', pros: ['Integrates everywhere'], cons: ['Transcription accuracy'], priceModel: 'Freemium', link: 'https://fireflies.ai', logo: '萤', lastCheck: '2025-12-01' }
    ]
  },
  {
    id: 'excel', title: 'Excel Analysis', description: 'Write formulas & analyze data', icon: 'excel',
    tags: ['Worker', 'Developer', 'Student'], // Engineer -> Developer
    tools: [
  ...
  // --- Dev ---
  {
    ...
    tags: ['Developer', 'Student'], // Engineer -> Developer
    tools: [
      ...
      { id: 'copilot', name: 'GitHub Copilot', rank: 'A', tagline: 'The industry standard', pros: ['IDE integration', 'Enterprise ready'], cons: ['Chat is weaker'], priceModel: 'Paid', link: 'https://github.com/features/copilot', logo: '🐙', lastCheck: '2025-12-01' }
    ]
  },
  {
  ...
  // --- Creative ---
  {
    ...
    tools: [
      ...
      { id: 'luma', name: 'Luma Dream Machine', rank: 'A', tagline: 'Fast & High quality', pros: ['Keyframe control', 'Fast generation'], cons: ['Consistency'], priceModel: 'Freemium', link: 'https://lumalabs.ai', logo: '🌙', lastCheck: '2025-12-01' }
    ]
  },
  {
    ...
    tools: [
      ...
      { id: 'flux', name: 'Flux.1', rank: 'A', tagline: 'Best open source model', pros: ['Great with text', 'Realistic hands'], cons: ['Hardware heavy'], priceModel: 'Free', link: 'https://blackforestlabs.ai', logo: '🌲', lastCheck: '2025-12-01' }
    ]
  },
  {
  ...
  },
  {
    ...
    tools: [
      { id: 'magnific', name: 'Magnific', rank: 'S', tagline: 'Hallucinate details', pros: ['Insane detail', 'Skin texture'], cons: ['Very expensive'], priceModel: 'Paid', link: 'https://magnific.ai', logo: '✨', lastCheck: '2025-12-01' }
    ]
  },
  ...
  // --- Life ---
  {
    ...
    tools: [
      ...
      { id: 'udio', name: 'Udio', rank: 'A', tagline: 'High fidelity audio', pros: ['Complex arrangements'], cons: ['Short clips'], priceModel: 'Freemium', link: 'https://www.udio.com', logo: '🎵', lastCheck: '2025-12-01' }
    ]
  },
  {
